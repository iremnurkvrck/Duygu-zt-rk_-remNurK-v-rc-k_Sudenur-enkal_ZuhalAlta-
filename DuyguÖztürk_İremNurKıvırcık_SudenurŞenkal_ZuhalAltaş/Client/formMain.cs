...
namespace Client
{
    public partial class formMain : Form
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                clientSocket.Connect("172.20.10.5", 5000);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            while (file.ShowDialog() == DialogResult.OK)

            {
                ...
                foreach (string fileName in file.FileNames)
                {
                    ...
                    Sender.Send(IPAddress.Parse("userList"), 1453, fileName);
        ...
        private void btnReciveFile_Click(object sender, EventArgs e)
        {
            if (btnReciveFile.Text == "Wait For Files")
            {
                try
                {
                    var file = new OpenFileDialog();
                    Listen.Start(int.Parse("1453"));
                    //Receive message

                    btnReciveFile.Text = "Cancel Waiting";
                }
                catch (Exception ex)
                {
            ...
            {
                Listen.Stop();
                btnReciveFile.Text = "Wait For Files";
                //StatusStopped();
            }
        }
